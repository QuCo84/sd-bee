...
define ( "WellKnownElementClasses", [
        ...
        UD_connector_googleCalendar=>"elements/udcgooglecalendar.php",
        UD_connector_dropZone=>"elements/udcdropzone.php",    
        UD_connector_service=>"elements/udcservice.php",    
        UD_connector_document=>"lements/udcdocument.php",    
        UDC_googleSheet => "elements/udcgooglesheet.php",  
        UDC_googleDoc => "elements/udcgoogledoc.php", 
        UDC_facebook => "elements/udcfacebook.php",
        // System
        UD_undefined=>"UDpara",   
        UD_imagePicker=>"elements/udimagepicker.php", 
